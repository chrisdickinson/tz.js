...
if(typeof assert === 'undefined') {
  var assert = require('assert')
    , tzinfo = require('../index') 
}

suite("dst", function() {

  test("get_offset_format", function() {
    var result
  ...
  test("tzinfo, has no dst", function() {
  ...
  test("tzinfo, has dst but is not dst (north)", function() {
    var fake_determine_thresholds = function() { return {
        spring_forward: 0
      , fall_back     : 100 
      } }
  ...
  test("tzinfo, has dst and is dst (north)", function() {
  ...
  test("tzinfo, has dst but is not dst (south)", function() { 
    var fake_determine_thresholds = function() { return {
        spring_forward: 100
      , fall_back     : 0
      } }
  ...
  test("tzinfo, has dst and is dst (south)", function() {
  ...
  test("no tzinfo available", function() {
    var fake_determine_thresholds = function() { return {
        spring_forward: 100 
      , fall_back     : 0 
      } }
